      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20">
          <div className="flex items-center">
            <Link to="/" aria-label="Home Protection" className="flex-shrink-0 flex items-center gap-1 sm:gap-2">
              ...
              <div className="flex flex-col">
                ...
                <span aria-hidden="true" className="text-[0.58rem] sm:text-[10px] uppercase tracking-[0.22em] text-blue-600 font-bold">Maintenance Experts</span>
              </div>
            </Link>
          </div>
